...
jQuery(document).ready(function () {
    ...
    jQuery('textarea.ckeditor, textarea.ckeditor_compact').each(function(index) {
        ...
        configurationData.language = 'fr';
        configurationData.skin = 'moono';
        ...
        configurationData.stylesSet = 'styleMab:plugins/stylescombo/styleMab.js';
        configurationData.templates_replaceContent = false;
        ...
        if(jQuery(this).hasClass("ckeditor_compact"))
        {
            ...
            configurationData.allowedContent = true;
        } else {
            configurationData.toolbar =
            [
                ['Styles','Templates'],
                ...
                ['Image'],['Link', 'Unlink', 'Anchor'], [ 'Source' ]
            ];
