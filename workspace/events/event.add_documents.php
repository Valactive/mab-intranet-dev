...
class eventadd_documents extends SectionEvent
{
    public $ROOTELEMENT = 'add-documents';
    ...
    public static function about()
    {
        return array(
            ...
            'release-date' => '2022-03-07T21:48:59+00:00',
...
&lt;/form></code></pre>
    ...
    {
        if (isset($_POST['action']['add-documents'])) {
