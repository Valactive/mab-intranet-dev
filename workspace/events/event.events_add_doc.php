...
class eventevents_add_doc extends SectionEvent
{
    public $ROOTELEMENT = 'events-add-doc';
    ...
    public static function about()
    {
        return array(
            ...
            'release-date' => '2022-03-07T21:49:39+00:00',
...
&lt;/form></code></pre>
    ...
    {
        if (isset($_POST['action']['events-add-doc'])) {
