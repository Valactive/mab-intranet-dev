<?php
	...
	Class eventevents_add_doc extends Event{

		const ROOTELEMENT = 'events-add-doc';
		...
		public static function about(){
			return array(
				...
				'release-date' => '2011-11-09T15:11:44+00:00',
				'trigger-condition' => 'action[events-add-doc]'
			);
		}
...
&lt;/events-add-doc></code></pre>
  ...
  &lt;/label>
  &lt;label>Auteur
    &lt;input name="fields[auteur]" type="text" />
  &lt;/label>
  &lt;label>Date
  ...
  &lt;/label>
  &lt;input name="action[events-add-doc]" type="submit" value="Envoyer" />
&lt;/form></code></pre>
		...
		public function load(){
			if(isset($_POST['action']['events-add-doc'])) return $this->__trigger();
		}
